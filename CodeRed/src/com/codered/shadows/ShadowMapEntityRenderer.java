...
public class ShadowMapEntityRenderer
{
	 ...
	 */
	protected void render(Map<TexturedModel, List<StaticEntity>> entities)
	{
		for (TexturedModel model : entities.keySet())
		{
			Mesh rawModel = model.getModel();
			bindModel(rawModel);
			for (StaticEntity entity : entities.get(model))
			{
	...
	private void prepareInstance(StaticEntity entity)
	{
		...
		modelMatrix.initModelMatrix(entity.getTransform().getPos(), entity.getTransform().getRot(), entity.getTransform().getScale());
