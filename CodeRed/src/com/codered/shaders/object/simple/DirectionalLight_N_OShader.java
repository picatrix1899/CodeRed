...
public class DirectionalLight_N_OShader extends TexturedObjectShader
{
	...
	{
		attachVertexShader(EngineRegistry.getShaderParts().builtIn().getVertexShader("o_directionalLight_N"));
		attachFragmentShader(EngineRegistry.getShaderParts().builtIn().getFragmentShader("o_directionalLight_N"));
	}
