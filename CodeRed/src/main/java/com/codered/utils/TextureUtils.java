...
{
	public static com.codered.rendering.texture.Texture genTexture2(int id, TextureData data)
	{
		int textureID = id;
		...
		return new com.codered.rendering.texture.Texture(textureID, data.width, data.height);
	}	
	
	public static com.codered.rendering.texture.Texture genTexture(int id, org.haze.png.Image data)
	{
		int textureID = id;
